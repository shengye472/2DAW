...
//    }
////----------------------------------------------------------------------
////    Explicación necesaria de Cesar o Marcos
...
//                VALUES (?, ?)
//                """;
//        authors.stream().forEach(author -> jdbcTemplate.update(sql, id, author.getId()));
//    }
//
//    private void insertGenres(long id, List<Genre> genres) {
//        String sql = """
//                INSERT INTO books_genres (book_id, author_id)
//                VALUES (?, ?)
//                """;
//        genres.stream().forEach(genre -> jdbcTemplate.update(sql, id, genre.getId()));
//    }
